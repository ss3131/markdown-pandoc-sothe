...
#Background {-}
![Figure 475. Where is this?](img/rio-grande-basin.png)
[This guy: @Bartolino_1979]
...
```{r plot, echo=TRUE}
plot(faithful, main = "Can I go home?", col="gold")
```
...
a. All original raw data files and data source processing programs will be
versioned over time and maintained in a date-stamped file structure with
text files documenting the provenance.
c. The database will be preserved in perpetuity, housed initially at the New Mexico Interstate Stream
